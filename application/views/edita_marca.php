...
<?php
  ...
  include 'extensao.php';
    ...
    $sql = mysqli_query($con, "select * from marca where idmarca = '$codigo' " );
    list($aaa, $marca) = mysqli_fetch_row($sql );
?>

    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9"> 
        <div class="card">
            <a href="../marca/pesquisar">
                <button type="button" class="close"  aria-label="Fechar"><span aria-hidden="true">&times;</span></button>
            </a>
            <div class="body">
                <form action="<?php echo site_url("marca/adicionar")?>" method="POST">
                    <div class="row clearfix">
                        <div class="body">
                            <ul class="list-group">
                                <center>
                                    <li class="list-group-item list-group-item-info"><h4>Edição de marcas</h4></li>
                                </center>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <label> Marca</label>
                                    <input type="text" value=<?php echo( $marca )?> class="form-control" name="nome" required>
                    ...
                    <center>
                        ...
                        <?php
                            echo "<a href=../marca/excluir?codigo=$codigo";
                        ?>
